...
/*
     	...
     	break;
  		...
  		case "7": // caja
            ...
            if (cierre == -1) chapeton = 0;
			else 
            {
                if (chapeton == 0)   chapeton = 30;
            }
        ...
        {  
          ...
          }else
          {
			...
			if (media_caja == 1){
				...
				if (centro == 0) {
				slotter = chapeton + ':' + a + ':' + l + ':' + a + ':' + l;
				}else if (centro == l) {
				slotter = chapeton + ':' + l + ':' + a + ':' + l + ':' + a ;
				}else{
				slotter = (chapeton *1 + centro * 1) + ':' + a + ':' + l + ':' + a + ':' + (l*1 - centro*1);
				}
				pl = (l + a) * 2 + chapeton + refile; 
	    	...
	    	$x(px + 'PLARGO').value = pl;
     		...
     		$x(px + 'MULT').value = mult;
     		$x(px + 'SLOTTER').value = slotter ;
            $x(px + 'CIERRE_VALOR').value = chapeton ;
